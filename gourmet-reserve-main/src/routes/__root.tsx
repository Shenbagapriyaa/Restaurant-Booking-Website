...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Curated restaurant reservations for unforgettable dining. Michelin-grade venues, instant confirmation." },
      { property: "og:title", content: "Maison — Premium Restaurant Reservations" },
      { property: "og:description", content: "Reserve tables at the world's most memorable restaurants." },
